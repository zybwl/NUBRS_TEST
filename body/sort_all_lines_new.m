function  new_pts = sort_all_lines_new( pts , max_error, newx, ix, newy, iy)
...
unoccupy_array = find(occupy == 10000, 1);
...
% if norm(new_pts(1,:) - new_pts(end,:)) > 1e-3
