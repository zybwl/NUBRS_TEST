...
X = squeeze(obj{i}.CtrlPts4D(1,:)); % Extract X Data
Y = squeeze(obj{i}.CtrlPts4D(2,:)); % Extract Y Data
Z = squeeze(obj{i}.CtrlPts4D(3,:)); % Extract Z Data
W = squeeze(obj{i}.CtrlPts4D(4,:)); % Extract Weights from coefficients
...
P(2,i) = obj{i}.NCtrlPts ; % Number of points - 1
P(3,i) = obj{i}.Order ; % Degree of curve
P(4,i) = 1; % PROP1 Planar curve (0 = Not Planar)***
P(5,i) = 1; % PROP2 Closed curve (0 = Not Closed)
P(6,i) = 1; % PROP3 (1 = all weights equal, 0 = rational)***
P(7,i) = 1; % PROP4 Periodic (0 = Not periodic)
Knots = obj{i}.KntVect(:);
Data{i} = [Knots; Weights; Coefs];
case 106
